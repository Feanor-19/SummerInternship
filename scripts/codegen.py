...
def start_link_h():
    FILE_LINK_H.write(AUTO_GEN_TEXT+"#pragma once\n\n")


def start_link_cpp():
    FILE_LINK_CPP.write(AUTO_GEN_TEXT+"#include \"link.h\"\n#include <dlfcn.h>\n\n")
...
def create_header_file(lib_name : str, includes : list[str], lib_funcs : list[(str, str, str)]):
    ...
    h_file.write(AUTO_GEN_TEXT+"#pragma once\n\n")
...
COMMENT_SYMBOL = ';'
AUTO_GEN_TEXT = "//THIS FILE IS AUTO-GENERATED BY SCRIPT!\n\n"
